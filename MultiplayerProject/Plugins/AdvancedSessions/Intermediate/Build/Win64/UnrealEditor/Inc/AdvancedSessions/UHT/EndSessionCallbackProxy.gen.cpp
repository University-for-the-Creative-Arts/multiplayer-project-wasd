...
FClassRegistrationInfo Z_Registration_Info_UClass_UEndSessionCallbackProxy;
UClass* UEndSessionCallbackProxy::GetPrivateStaticClass()
{
	using TClass = UEndSessionCallbackProxy;
	if (!Z_Registration_Info_UClass_UEndSessionCallbackProxy.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EndSessionCallbackProxy"),
			Z_Registration_Info_UClass_UEndSessionCallbackProxy.InnerSingleton,
			StaticRegisterNativesUEndSessionCallbackProxy,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEndSessionCallbackProxy.InnerSingleton;
}
UClass* Z_Construct_UClass_UEndSessionCallbackProxy_NoRegister()
{
	return UEndSessionCallbackProxy::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UEndSessionCallbackProxy_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEndSessionCallbackProxy_EndSession, "EndSession" }, // 3479191306
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_2106125_Documents_GitHub_multiplayer_project_wasd_MultiplayerProject_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_EndSessionCallbackProxy_h__Script_AdvancedSessions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEndSessionCallbackProxy, UEndSessionCallbackProxy::StaticClass, TEXT("UEndSessionCallbackProxy"), &Z_Registration_Info_UClass_UEndSessionCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEndSessionCallbackProxy), 3985599390U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_2106125_Documents_GitHub_multiplayer_project_wasd_MultiplayerProject_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_EndSessionCallbackProxy_h__Script_AdvancedSessions_3791800002(TEXT("/Script/AdvancedSessions"),
	Z_CompiledInDeferFile_FID_Users_2106125_Documents_GitHub_multiplayer_project_wasd_MultiplayerProject_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_EndSessionCallbackProxy_h__Script_AdvancedSessions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_2106125_Documents_GitHub_multiplayer_project_wasd_MultiplayerProject_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_EndSessionCallbackProxy_h__Script_AdvancedSessions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
